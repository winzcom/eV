...
class MySqlUserRepo extends BaseRepo implements UserRepoInterface{
    ...
    public function getRequests(){
        ...
        $d = DB::select(DB::raw(
            ...
            inner join categories on quotes_request.category_id = categories.id
            ...
            where dismiss.rid is null 
            and timestampdiff(DAY,companies.created_at,quotes_request.created_at) > 0 
