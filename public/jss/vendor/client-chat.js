...
$(document).ready(function(){
     ...
     function loadPreviousMessage(currentChannel,client_id) {
        ...
        messageListQuery.load(30, true, function(message_list, error){
          ...
          window.requestAnimationFrame(function(time){
             displayPreviousMessages(message_list,client_id);
          })
       });
     }

     function sendChannelUrlToServer(channel_url,client_id) {
    ...
    function displayPreviousMessages(message_list,client_id) {
        if(!message_list)
            return;
